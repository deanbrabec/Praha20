...
class YS_Widget_Recent_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'ys_widget_recent_entries',
			'description' => __( 'Your site&#8217;s most recent Posts (modified by Your System).' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'ys-recent-posts', __( 'YS Recent Posts' ), $widget_ops );
		$this->alt_option_name = 'ys_widget_recent_entries';
	}
